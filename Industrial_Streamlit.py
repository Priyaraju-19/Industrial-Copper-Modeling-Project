...
with tab1:
    ...
    if submit_button and flag == 0:
        ...
        loaded_model = load('/Users/padhmapriya/Downloads/model.joblib')
        scaler_loaded = load('/Users/padhmapriya/Downloads/scaler.joblib')
        t_loaded = load('/Users/padhmapriya/Downloads/t.joblib')
        s_loaded = load('/Users/padhmapriya/Downloads/s.joblib')
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        # Load the model and scalers using joblib
        cloaded_model = load('/Users/padhmapriya/Downloads/cmodel.joblib')
        cscaler_loaded = load('/Users/padhmapriya/Downloads/cscaler.joblib')
        ct_loaded = load('/Users/padhmapriya/Downloads/ct.joblib')
