...
with tab1:
    ...
    if submit_button and flag == 0:
        ...
        with open(r"/Users/padhmapriya/Downloads/model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r"/Users/padhmapriya/Downloads/scaler.pkl", 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r"/Users/padhmapriya/Downloads/t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open(r"/Users/padhmapriya/Downloads/s.pkl", 'rb') as f:
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"/Users/padhmapriya/Downloads/cmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r"/Users/padhmapriya/Downloads/cscaler.pkl", 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r"/Users/padhmapriya/Downloads/ct.pkl", 'rb') as f:
...
st.write(f'<h6 style="color:#ee4647;">App Created by Padhma Priya</h6>', unsafe_allow_html=True)
